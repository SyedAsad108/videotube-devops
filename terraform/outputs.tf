...
output "cloudfront_domain_name" {
  ...
  value       = try(aws_cloudfront_distribution.main[0].domain_name, "pending-account-verification")
}

output "cloudfront_distribution_id" {
  description = "ID of the CloudFront distribution"
  value       = try(aws_cloudfront_distribution.main[0].id, "pending-account-verification")
}
